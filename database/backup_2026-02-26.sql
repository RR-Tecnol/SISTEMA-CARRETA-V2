...
\restrict eHPJ4ZX5cdmSUu0qnhIESnZdYdmu9VdewcNOZVUMCKKf3j4CFCePMexqzcu3vVx
...
ALTER TABLE IF EXISTS ONLY public.pontos_medicos DROP CONSTRAINT IF EXISTS pontos_medicos_funcionario_id_fkey;
ALTER TABLE IF EXISTS ONLY public.pontos_medicos DROP CONSTRAINT IF EXISTS pontos_medicos_acao_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.manutencoes_caminhao DROP CONSTRAINT IF EXISTS manutencoes_caminhao_caminhao_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.funcionario_anotacoes DROP CONSTRAINT IF EXISTS funcionario_anotacoes_funcionario_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.atendimentos_medicos DROP CONSTRAINT IF EXISTS atendimentos_medicos_ponto_id_fkey;
ALTER TABLE IF EXISTS ONLY public.atendimentos_medicos DROP CONSTRAINT IF EXISTS atendimentos_medicos_funcionario_id_fkey;
ALTER TABLE IF EXISTS ONLY public.atendimentos_medicos DROP CONSTRAINT IF EXISTS atendimentos_medicos_cidadao_id_fkey;
ALTER TABLE IF EXISTS ONLY public.atendimentos_medicos DROP CONSTRAINT IF EXISTS atendimentos_medicos_acao_id_fkey;
ALTER TABLE IF EXISTS ONLY public.acoes DROP CONSTRAINT IF EXISTS acoes_responsavel_tecnico_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.pontos_medicos DROP CONSTRAINT IF EXISTS pontos_medicos_pkey;
...
ALTER TABLE IF EXISTS ONLY public.manutencoes_caminhao DROP CONSTRAINT IF EXISTS manutencoes_caminhao_pkey;
...
ALTER TABLE IF EXISTS ONLY public.funcionario_anotacoes DROP CONSTRAINT IF EXISTS funcionario_anotacoes_pkey;
...
ALTER TABLE IF EXISTS ONLY public.atendimentos_medicos DROP CONSTRAINT IF EXISTS atendimentos_medicos_pkey;
...
DROP TABLE IF EXISTS public.pontos_medicos;
...
DROP TABLE IF EXISTS public.manutencoes_caminhao;
...
DROP TABLE IF EXISTS public.funcionario_anotacoes;
...
DROP TABLE IF EXISTS public.atendimentos_medicos;
...
DROP TYPE IF EXISTS public.enum_pontos_medicos_status;
...
DROP TYPE IF EXISTS public.enum_atendimentos_medicos_status;
...
0088f17b-007e-484f-ba88-86cc7b430291	funcionario	Funcion├írio: Jo├úo Baluz - A├º├úo 5	49600.00	2026-10-14 15:00:00+00	\N	pendente	/uploads/comprovantes/comprovante-1772072817748-856368205.png	f	Custo di├írio: R$ 200.00 ├ù 248 dias	2026-02-26 02:14:57.807+00	2026-02-26 02:26:57.754+00	\N	e224b611-c6f4-421a-80a9-40ec63f654ff	Buriticupu	\N
\.
...
ccd3a81c-da61-4856-b769-7f8009b8761e	gabriel diniz	motorista	Caminh├Áes	150.00	2026-02-08 17:13:17.007+00	2026-02-08 17:23:10.53+00	11144477735	9888888888	gg@gmail.com	t	f	\N	\N	\N	f	\N	\N
...
8c4c4416-1e09-4000-b595-65f1b9f6e9de	Jo├úo Baluz	M├®dico	Clinico Geral	200.00	2026-02-08 17:37:19.43+00	2026-02-26 02:17:49.433+00	22423192304	98982450008	joaobaluz@gmail.com	t	t		$2b$10$/Ptxe6Zw0KwtPany0DIqn.vlI55ACzQTcda7Ml/vSaaZlWlIRjcHe	678978	f	\N	\N
...
5bb00086-9f2f-435f-8a80-5f5d4c077833	Carretas da Sa├║de iniciam mutir├úo de consultas e exames em munic├¡pios do Maranh├úo	O Governo do Estado, por meio da Secretaria de Sa├║de, deu in├¡cio nesta semana a uma nova etapa do mutir├úo das Carretas da Sa├║de. A iniciativa visa descentralizar o atendimento m├®dico e reduzir as filas de espera por procedimentos de m├®dia complexidade em diversas regi├Áes do Maranh├úo.\r\n\r\nAs unidades m├│veis est├úo equipadas para oferecer servi├ºos como:\r\n\r\nConsultas ginecol├│gicas e preventivos (Papanicolau);\r\n\r\nMamografias para rastreamento do c├óncer de mama;\r\n\r\nAtendimento odontol├│gico completo;\r\n\r\nExames laboratoriais e de imagem (ultrassonografia).\r\n\r\n"Nosso objetivo ├® garantir que a popula├º├úo que vive longe dos grandes centros urbanos tenha acesso a um diagn├│stico r├ípido e humanizado", afirmou o coordenador da a├º├úo. Para ser atendido, o cidad├úo deve comparecer ao local com documento de identidade, cart├úo do SUS e comprovante de resid├¬ncia.\r\n\r\nCronograma: As carretas permanecer├úo em cada localidade por cerca de cinco dias, seguindo um calend├írio que percorrer├í as regionais de sa├║de de Chapadinha, Pinheiro e Imperatriz nesta fase inicial.	/uploads/noticias/noticia-1772135105029-990445420.webp	\N	f	2026-02-26 00:00:00+00	{"resumo": "Programa itinerante leva atendimento especializado, exames preventivos e servi├ºos odontol├│gicos para fortalecer a assist├¬ncia m├®dica no interior do estado.", "categoria": "Geral"}	t	2026-02-26 19:31:43.781+00	2026-02-26 19:45:05.075+00
\.
...
--
-- Name: acoes acoes_responsavel_tecnico_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict eHPJ4ZX5cdmSUu0qnhIESnZdYdmu9VdewcNOZVUMCKKf3j4CFCePMexqzcu3vVx
