...
author: renat
security_review: "APROVADA COM MODIFICAÇÕES — disclaimer legal adicionado, restrição de uso documentada"
tags:
- legal
- brazilian-law
- multi-domain
...
# ⚠️ VERSÃO CORPORATIVA MODIFICADA — 2026-04-06

> **⚠️ DISCLAIMER LEGAL OBRIGATÓRIO**
>
> Esta skill é uma ferramenta de **apoio à pesquisa jurídica** e **análise de documentos processuais**.
> **NÃO substitui** a orientação de um **advogado habilitado** (OAB).
> Valores de indenização, prazos e estratégias processuais são **referências de pesquisa** —
> não garantias de resultado. Decisões jurídicas devem ser tomadas com base em consulta profissional.
>
> **Política de uso corporativo:**
> - ✅ Análise e classificação de documentos judiciais
> - ✅ Pesquisa de base legal e jurisprudência
> - ✅ Apoio a profissionais jurídicos do time
> - ❌ Não usar para orientação direta a usuários finais leigos sem supervisão de advogado
> - ❌ Não usar como única fonte de decisão em processos com alto risco financeiro ou penal
>
> **Legislação:** Atualizada até 2025. Revisar em: **2026-07-06** ou após mudança legislativa relevante.
