...
\restrict uEKodM80zFeSipmPy5I2yLhVXVU31fAs9iJqaiUnwcp6WkrYnDrF3bEa2R8y1zl
...
--
-- Name: enum_atendimentos_medicos_status; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.enum_atendimentos_medicos_status OWNER TO postgres;
...
--
-- Name: enum_pontos_medicos_status; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.enum_pontos_medicos_status OWNER TO postgres;
...
COMMENT ON COLUMN public.abastecimentos.preco_por_litro IS 'Preço por litro (calculado: valor_total / litros)';
...
COMMENT ON COLUMN public.acoes.distancia_km IS 'Distância em km de São Luís até o município da ação';
...
COMMENT ON COLUMN public.acoes.preco_combustivel_referencia IS 'Preço de referência do combustível em R$/litro';
...
COMMENT ON COLUMN public.acoes.permitir_inscricao_previa IS 'Permite inscrição antecipada para esta ação';
...
COMMENT ON COLUMN public.acoes_insumos.quantidade_planejada IS 'Quantidade planejada para a ação';
...
COMMENT ON COLUMN public.acoes_insumos.quantidade_utilizada IS 'Quantidade efetivamente utilizada na ação';
...
COMMENT ON COLUMN public.acoes_insumos.quantidade_retornada IS 'Quantidade que retornou após a ação';
...
--
-- Name: atendimentos_medicos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.atendimentos_medicos OWNER TO postgres;

--
-- Name: COLUMN atendimentos_medicos.duracao_minutos; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.atendimentos_medicos.duracao_minutos IS 'Duração total do atendimento em minutos (calculado ao finalizar)';


--
-- Name: COLUMN atendimentos_medicos.nome_paciente; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.atendimentos_medicos.nome_paciente IS 'Nome do paciente (preenchido caso não tenha cidadao_id vinculado)';
...
COMMENT ON COLUMN public.caminhoes.km_por_litro IS 'Autonomia do caminhão em km por litro';
...
COMMENT ON COLUMN public.cidadaos.cartao_sus IS 'Número do Cartão Nacional de Saúde (CNS)';
...
COMMENT ON COLUMN public.contas_pagar.recorrente IS 'Indica se a conta é recorrente (mensal)';
...
COMMENT ON COLUMN public.estoque_caminhoes.quantidade IS 'Quantidade atual do insumo no caminhão';
...
COMMENT ON COLUMN public.exames.instrucoes_preparo IS 'Instruções de preparo para o exame (ex: jejum de 12h)';
...
COMMENT ON COLUMN public.exames.valores_referencia IS 'Valores de referência normais para o exame';
...
--
-- Name: funcionario_anotacoes; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.funcionario_anotacoes OWNER TO postgres;
...
COMMENT ON COLUMN public.insumos.nome IS 'Nome do insumo (ex: Luvas descartáveis, Máscaras N95)';
...
COMMENT ON COLUMN public.insumos.descricao IS 'Descrição detalhada do insumo';
...
COMMENT ON COLUMN public.insumos.quantidade_minima IS 'Quantidade mínima para alerta de estoque baixo';
...
COMMENT ON COLUMN public.insumos.preco_unitario IS 'Preço unitário médio do insumo';
...
COMMENT ON COLUMN public.insumos.codigo_barras IS 'Código de barras do produto';
...
COMMENT ON COLUMN public.insumos.lote IS 'Número do lote';
...
COMMENT ON COLUMN public.insumos.nota_fiscal IS 'Número da nota fiscal de entrada';
...
COMMENT ON COLUMN public.insumos.localizacao IS 'Localização física no estoque (prateleira, setor)';


--
-- Name: manutencoes_caminhao; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.manutencoes_caminhao OWNER TO postgres;
...
COMMENT ON COLUMN public.movimentacoes_estoque.tipo IS 'Tipo de movimentação do estoque';
...
COMMENT ON COLUMN public.movimentacoes_estoque.quantidade_anterior IS 'Quantidade antes da movimentação';
...
COMMENT ON COLUMN public.movimentacoes_estoque.quantidade_atual IS 'Quantidade após a movimentação';
...
COMMENT ON COLUMN public.movimentacoes_estoque.nota_fiscal IS 'Número da nota fiscal relacionada';
...
COMMENT ON COLUMN public.movimentacoes_estoque.usuario_id IS 'ID do usuário que realizou a movimentação';
...
--
-- Name: pontos_medicos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.pontos_medicos OWNER TO postgres;

--
-- Name: COLUMN pontos_medicos.horas_trabalhadas; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.pontos_medicos.horas_trabalhadas IS 'Total de horas trabalhadas no turno (calculado na saída)';
...
c7d950b1-508e-4ad9-954f-85eb236b8e88	e224b611-c6f4-421a-80a9-40ec63f654ff	8c4c4416-1e09-4000-b595-65f1b9f6e9de	2026-02-23 22:29:58.453+00	2026-02-23 22:30:12.67+00	200.00	2
...
0d56a264-3f0e-4ae6-a143-757fbe8ec71c	2	d2120645-e88f-4c12-a31c-0f60c2ddacbe	saude	Sao Luis	MA	2026-02-06	2026-02-09	planejada		Renascença	50	1000	7.000	{}	2026-02-07 20:47:36.444+00	2026-02-07 20:47:36.444+00	t	Campanha de Exame de Vista
53df1c14-a0b7-49ed-9292-607e4f17b15e	1	d2120645-e88f-4c12-a31c-0f60c2ddacbe	saude	Sao Luis	MA	2026-02-06	2026-02-09	ativa		Renascença	110	100	6.000	{}	2026-02-07 19:39:00.584+00	2026-02-12 19:00:45.718+00	f	Campanha de Hemograma
b1131d02-3ea1-4da3-b856-e498390bc46a	6	d2120645-e88f-4c12-a31c-0f60c2ddacbe	saude	Raposa	MA	2026-02-21	2026-02-22	planejada		Hospital Raposa	10	20	6.000	{}	2026-02-22 19:43:34.975+00	2026-02-22 19:43:34.975+00	t	Campanha Raposa
13fcfd57-07c6-418e-a130-f4ff0cf9095d	3	d2120645-e88f-4c12-a31c-0f60c2ddacbe	saude	Sao Luis	MA	2026-05-03	2026-06-04	planejada		Renascença	45	500	6.000	{}	2026-02-08 16:37:43.308+00	2026-02-22 22:12:25.142+00	t	Campanha de Hemograma
a5695469-45ec-41a0-ab7f-14f5447a93de	4	d2120645-e88f-4c12-a31c-0f60c2ddacbe	saude	Sao Luis	MA	2026-05-04	2026-08-04	planejada	teste	Renascença	200	500	6.000	{}	2026-02-08 17:03:49.171+00	2026-02-22 22:12:32.722+00	t	Campanha de Hemograma
e224b611-c6f4-421a-80a9-40ec63f654ff	5	d2120645-e88f-4c12-a31c-0f60c2ddacbe	saude	Buriticupu	MA	2026-02-09	2026-10-14	planejada		Renascença	50	200	6.000	{}	2026-02-09 20:22:19.303+00	2026-02-22 22:12:50.272+00	t	campanha buriticupu
\.
...
--
-- Data for Name: atendimentos_medicos; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
7d4f4e43-54c7-40cb-a3fa-46e9041cbff6	8c4c4416-1e09-4000-b595-65f1b9f6e9de	\N	\N	eea5c565-8d03-4dd0-a863-e95921880667	2026-02-24 00:21:58.613+00	\N	\N	aguardando	\N	João Gabriel	2026-02-24 00:21:58.614+00	2026-02-24 00:21:58.614+00
5ebd04d7-764d-45af-a527-c93384ccabe9	605.022.853-11	Giovanna Fecury	2001-08-02	98987272826	giovannafecy@gmail.com	123456	cidadao	São Paulo	MA	01220000	Rua Bento Freitas 	420		Republica	{}	f	\N	\N	\N	\N	\N	2026-02-22 19:46:24.388+00	2026-02-22 22:05:29.904+00	\N	preta	masculino	Hilzi Oliveira
\.
...
39ba9101-2bdd-4449-9708-e7b9945aa48c	espontaneo	CUSTO ALIMENTAÇAO	200.00	2026-02-08 00:00:00+00	\N	pendente	\N	f	\N	2026-02-09 15:04:53.209+00	2026-02-09 15:04:53.209+00	\N	\N	\N	\N
...
86890639-f220-411b-9546-b7711739b7b5	funcionario	Funcionário: João Baluz - Ação 4	18600.00	2026-08-04 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 200.00 × 93 dias	2026-02-09 16:25:52.385+00	2026-02-09 16:25:52.385+00	\N	a5695469-45ec-41a0-ab7f-14f5447a93de	Sao Luis	\N
07e8233a-ac0c-49f3-9146-d53f6cf58190	funcionario	Funcionário: gabriel diniz - Ação 3	4950.00	2026-06-04 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 150.00 × 33 dias	2026-02-09 16:26:28.73+00	2026-02-09 16:26:28.73+00	\N	13fcfd57-07c6-418e-a130-f4ff0cf9095d	Sao Luis	\N
07502332-ab09-433c-9897-bf66081abf4b	funcionario	Funcionário: Ronaldo - Ação 3	19800.00	2026-06-04 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 600.00 × 33 dias	2026-02-09 16:27:32.986+00	2026-02-09 16:27:32.986+00	\N	13fcfd57-07c6-418e-a130-f4ff0cf9095d	Sao Luis	\N
23665d66-70df-499f-aae2-277e0dcf4487	funcionario	Funcionário: João Baluz - Ação 2	800.00	2026-02-09 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 200.00 × 4 dias	2026-02-09 16:27:58.458+00	2026-02-09 16:27:58.458+00	\N	0d56a264-3f0e-4ae6-a143-757fbe8ec71c	Sao Luis	\N
3f7278cb-cc39-4b95-b6b5-9f39f9f1804f	funcionario	Funcionário: Ronaldo - Ação 5	148800.00	2026-10-14 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 600.00 × 248 dias	2026-02-09 20:26:24.139+00	2026-02-09 20:26:24.139+00	\N	e224b611-c6f4-421a-80a9-40ec63f654ff	Sao Luis	\N
...
15617de1-a159-4608-83ac-30d14a4c6d70	manutencao	Manutenção: Troca de Óleo 	600.00	2026-02-22 15:00:00+00	\N	pendente	\N	f	\N	2026-02-21 21:05:42.389+00	2026-02-21 21:05:42.389+00	\N	\N	\N	6e0bba4d-29c3-43d4-8e6d-02ad332f3683
7cd33a72-7074-4b72-9320-03b706526f64	manutencao	Manutenção: Troca de Óleo 	500.00	2026-02-19 15:00:00+00	2026-02-21 21:38:53.993+00	paga	\N	f	\N	2026-02-21 21:04:00.873+00	2026-02-21 21:38:53.993+00	\N	\N	\N	a5efd07f-12cf-4289-a55f-fb758ebdec53
17c571ba-fe03-42f8-a814-22cf5ef5467a	funcionario	Funcionário: João Baluz - Ação 6	400.00	2026-02-22 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 200.00 × 2 dias	2026-02-22 19:43:55.188+00	2026-02-22 19:43:55.188+00	\N	b1131d02-3ea1-4da3-b856-e498390bc46a	Raposa	\N
cb5cb817-992e-412f-b5eb-57aa6b212c02	funcionario	Funcionário: Ronaldo - Ação 6	1200.00	2026-02-22 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 600.00 × 2 dias	2026-02-22 22:13:22.359+00	2026-02-22 22:13:22.359+00	\N	b1131d02-3ea1-4da3-b856-e498390bc46a	Raposa	\N
399a8936-ce8a-4714-a676-c92039e733f3	funcionario	Funcionário: João Baluz - Ação 5	49600.00	2026-10-14 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 200.00 × 248 dias	2026-02-23 22:29:58.487+00	2026-02-23 22:29:58.487+00	\N	e224b611-c6f4-421a-80a9-40ec63f654ff	Buriticupu	\N
3524c6d3-a45e-49cf-8585-282aeb6f1882	funcionario	Funcionário: gabriel diniz - Ação 1	1000.00	2026-02-09 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 200.00 × 5 dias	2026-02-23 23:44:20.699+00	2026-02-23 23:44:39.613+00	\N	53df1c14-a0b7-49ed-9292-607e4f17b15e	Sao Luis	\N
77c0dde8-9005-4060-992f-22b9c4ee080c	funcionario	Funcionário: Ronaldo - Ação 1	3600.00	2026-02-09 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 600.00 × 6 dias	2026-02-23 23:36:03.058+00	2026-02-23 23:45:13.864+00	\N	53df1c14-a0b7-49ed-9292-607e4f17b15e	Sao Luis	\N
...
cc0f83cc-3e83-4e3d-b8e6-9c5a99600a8a	funcionario	Funcionário: João Baluz - Ação 3	6600.00	2026-06-04 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 200.00 × 33 dias	2026-02-23 23:36:31.513+00	2026-02-23 23:36:31.513+00	\N	13fcfd57-07c6-418e-a130-f4ff0cf9095d	Sao Luis	\N
db666ed7-154b-4781-9d22-44e654443332	funcionario	Funcionário: gabriel diniz - Ação 6	300.00	2026-02-22 15:00:00+00	\N	pendente	\N	f	Custo diário: R$ 150.00 × 2 dias	2026-02-23 23:37:31.507+00	2026-02-23 23:37:31.507+00	\N	b1131d02-3ea1-4da3-b856-e498390bc46a	Raposa	\N
\.
...
--
-- Data for Name: funcionario_anotacoes; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.funcionario_anotacoes (id, funcionario_id, titulo, conteudo, cor, pinned, created_at, updated_at) FROM stdin;
feb5c3e9-72c4-45b9-8946-b450d568f087	8c4c4416-1e09-4000-b595-65f1b9f6e9de	Contratação joão Baluz	No dia 23 foi a entrada e contratação do medico	#27ae60	f	2026-02-24 00:06:50.436+00	2026-02-24 00:11:12.675+00
\.
...
COPY public.funcionarios (id, nome, cargo, especialidade, custo_diaria, created_at, updated_at, cpf, telefone, email, ativo, is_medico, login_cpf, senha) FROM stdin;
ccd3a81c-da61-4856-b769-7f8009b8761e	gabriel diniz	motorista	Caminhões	150.00	2026-02-08 17:13:17.007+00	2026-02-08 17:23:10.53+00	11144477735	9888888888	gg@gmail.com	t	f	\N	\N
c0c98e21-0728-41cb-8b27-c57514b694b9	021f1eef-00ca-400c-9762-4f39ab0ea173	53df1c14-a0b7-49ed-9292-607e4f17b15e	be4727af-2919-40a8-8284-e827b41eb93d	atendido	2026-02-09 16:56:02.841+00	\N	{}	2026-02-09 16:56:02.841+00	2026-02-23 22:35:11.505+00
8cfce84c-4c23-4a0e-805a-e48c1d1388a7	d27c86e1-4249-4bfa-b678-223942b73224	13fcfd57-07c6-418e-a130-f4ff0cf9095d	be4727af-2919-40a8-8284-e827b41eb93d	atendido	2026-02-21 20:03:25.184+00	\N	{}	2026-02-21 20:03:25.185+00	2026-02-24 00:22:14.235+00
e13f3f5c-e6a5-46c0-bc88-e1a3ece9a351	021f1eef-00ca-400c-9762-4f39ab0ea173	e224b611-c6f4-421a-80a9-40ec63f654ff	be4727af-2919-40a8-8284-e827b41eb93d	atendido	2026-02-21 20:11:10.344+00	\N	{}	2026-02-21 20:11:10.344+00	2026-02-24 01:25:36.417+00
\.
...
d2120645-e88f-4c12-a31c-0f60c2ddacbe	SENAI - SÃO LUIS	10566.16816814	joao gabriel 	joaogabrieldiniz2307@gmail.com	98987272826	Rua bento freitas	{}	t	2026-02-07 19:37:52.905+00	2026-02-07 19:37:52.905+00
\.
...
34e5de8d-42cf-484f-9b68-a7ebb0022ea8	Luva plastica	lva çatex branca	MATERIAL_DESCARTAVEL	caixa	2	3	\N	000125458788	1908	2028-06-08 00:00:00+00	Governo	\N	\N	prateleira 24	t	2026-02-09 20:33:44.013+00	2026-02-09 20:34:03.457+00
\.


--
-- Data for Name: manutencoes_caminhao; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
8ca28c9e-eaad-4a10-b8cd-4f710c929206	a5efd07f-12cf-4289-a55f-fb758ebdec53	revisao	Troca de Óleo 	Serviço feito no posto são marcos	concluida	media	4000	8000	2026-02-19	2026-02-19	\N	500.00	Posto são marcos	Julio	\N	2026-02-21 21:04:00.722+00	2026-02-22 17:26:18.409+00	paga
2f53a951-d1d6-44bb-bcf7-9091f1b831b8	6e0bba4d-29c3-43d4-8e6d-02ad332f3683	corretiva	Troca de Óleo 	Feita rapidamente	concluida	media	4000	8000	2026-02-22	2026-02-22	\N	600.00	Posto são marcos	Julio	\N	2026-02-21 21:05:42.37+00	2026-02-23 19:43:05.153+00	pendente
\.
...
--
-- Data for Name: pontos_medicos; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: atendimentos_medicos atendimentos_medicos_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: funcionario_anotacoes funcionario_anotacoes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: manutencoes_caminhao manutencoes_caminhao_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pontos_medicos pontos_medicos_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: atendimentos_medicos atendimentos_medicos_acao_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: atendimentos_medicos atendimentos_medicos_cidadao_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: atendimentos_medicos atendimentos_medicos_funcionario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: atendimentos_medicos atendimentos_medicos_ponto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: funcionario_anotacoes funcionario_anotacoes_funcionario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: manutencoes_caminhao manutencoes_caminhao_caminhao_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pontos_medicos pontos_medicos_acao_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pontos_medicos pontos_medicos_funcionario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict uEKodM80zFeSipmPy5I2yLhVXVU31fAs9iJqaiUnwcp6WkrYnDrF3bEa2R8y1zl
